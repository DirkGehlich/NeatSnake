...
public class Parameters {
	...
	public static float c3 = 0.5f;
	public static float compatibilityThreshold = 6.0f;
	...
	public static float weightMutationPower = 0.5f;
	public static float enableGeneMutationChance = 0.01f;
	public static float addNodeMutationChance = 0.2f;
	public static float deleteNodeMutationChance = 0.0f;
	public static float addConnectionMutationChance = 0.5f;
	public static float deleteConnectionMutationChance = 0.0f;
	public static float removeWeakestGenomesPercentage = 0.6f;
